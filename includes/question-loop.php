...
function ap_question_get_the_subscriber_count() {
	...
	/**
	 * Return the license for active question
	 * @return String
	 * @since 2.1
	 */
function ap_question_get_the_license() {
	$question_id = ap_question_get_the_ID();
	$license = get_post_meta( $question_id, ANSPRESS_LICENSE_META, true );
	switch ($license){
		case 0:
...
/**
	 * Return the medium for active question
	 * @return String
	 * @since 2.1
	 */
function ap_question_the_medium() {
	$question_id = ap_question_get_the_ID();
	$medium = get_post_meta( $question_id, ANSPRESS_MEDIUM_META, true );
	echo $medium;
}
