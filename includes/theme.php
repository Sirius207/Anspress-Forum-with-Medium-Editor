...
function ap_assets( ) {
	...
	$assets = array(
		'js' => array(
			...
			//medium like editor
			'jquery-2.2.4-js' => array( 'src' => 'https://code.jquery.com/jquery-2.2.4.js' ),
			'handlebars-runtime-js' => array( 'src' => 'https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.0.5/handlebars.runtime.js', 'dep' => array( 'jquery' ) ),
			'medium-editor-min-js' => array( 'src' => '//cdn.jsdelivr.net/medium-editor/latest/js/medium-editor.min.js' ),
			'jquery-sortable-js' => array( 'src' => ap_get_theme_url( 'js/medium/jquery-sortable.js' ), 'dep' => array( 'jquery' ) ),
			'jquery-ui-widget-js' => array( 'src' => ap_get_theme_url( 'js/medium/jquery.ui.widget.js' ), 'dep' => array( 'jquery' ) ),
			'jquery-iframe-transport-js' => array( 'src' => ap_get_theme_url( 'js/medium/jquery.iframe-transport.js' ), 'dep' => array( 'jquery' ) ),
			'jquery-fileupload-js' => array( 'src' => ap_get_theme_url( 'js/medium/jquery.fileupload.js' ), 'dep' => array( 'jquery' ) ),
			'medium-editor-insert-plugin-js' => array( 'src' => ap_get_theme_url( 'js/medium/medium-editor-insert-plugin.js' ), 'dep' => array( 'jquery' ) ),
		),
		...
		'css' => array(
			...
			// medium like editor
			'medium-editor.min-css' => array( 'src' => '//cdn.jsdelivr.net/medium-editor/latest/css/medium-editor.min.css' ),
			'medium-editor-insert-plugin-css' => array( 'src' => ap_get_theme_url( '/js/medium/medium-editor-insert-plugin.css' ) ),
			'font-awesome-css' => array( 'src' => 'http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css' ),
		),
	);
